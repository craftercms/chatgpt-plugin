        ...
        shortcuts: [
            ...
            },
            {
                ...
                messages: [
                    {
                        role: 'user',
                        content: 'Rewrite this content with no spelling mistakes, proper grammar, and with more descriptive language, using best writing practices without losing the original meaning. Context: """{context}"""'
                    }
                ]
            },
            {
                ...
                messages: [
                    {
                        role: 'user',
                        content: 'Rewrite this content with simplified language and reduce the complexity of the writing, so that the content is easier to understand. Context: """{context}"""'
                    }
                ]
            },
            {
                ...
                messages: [
                    {
                        role: 'user',
                        content: 'Expand upon this content with descriptive language and more detailed explanations, to make the writing easier to understand and increase the length of the content. Context: """{context}"""'
                    }
                ]
            },
            {
                ...
                messages: [
                    {
                        role: 'user',
                        content: 'Remove any repetitive, redundant, or non-essential writing in this content without changing the meaning or losing any key information. Context: """{context}"""'
                    }
                ]
            },
            {
                ...
                shortcuts: [
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content using polished, formal, and respectful language to convey professional expertise and competence. Context: """{context}"""'
                            }
                        ]
                    },
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content with casual, informal language to convey a casual conversation with a real person. Context: """{context}"""'
                            }
                        ]
                    },
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content with direct language using only the essential information. Context: """{context}"""'
                            }
                        ]
                    },
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content using compelling, optimistic language to convey confidence in the writing. Context: """{context}"""'
                            }
                        ]
                    },
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content using friendly, comforting language, to convey understanding and empathy. Context: """{context}"""'
                            }
                        ]
                    }
                ]
                ...
                shortcuts: [
                    ...
                    },
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content as a legal professional using valid legal terminology. Context: """{context}"""'
                            }
                        ]
                    },
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content as a journalist using engaging language to convey the importance of the information. Context: """{context}"""'
                            }
                        ]
                    },
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content as a medical professional using valid medical terminology. Context: """{context}"""'
                            }
                        ]
                    },
                    {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: 'Rewrite this content as a poem using poetic techniques without losing the original meaning. Context: """{context}"""'
                            }
                        ]
                    }
                ]
