...
async function chatGPTUpdateContentType(contentTypeId, templatePath, instructions, currentContent) {
    ...
    const completion = await createChatCompletion({
        ...
        messages: [
          ...
          - Create an individual field for each image\n
          - Create an individaul text field for each headline\n
          - Create an individual rich-text field for any text or markup inside of div tags\n
